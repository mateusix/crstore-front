<template>
  <v-main style="background-color: white; height: 100vh; text-align: center;">
    <v-row style="background-color: #fafafa" justify="center" no-gutters>
      ...
      <v-spacer/>
      <v-btn class="mx-2 mt-3" to="/loguin" color="#ea1d2c">
        entrar
      </v-btn>
      <v-btn class="mx-2 mt-3" to="/register" color="#ea1d2c">
        criar conta 
      </v-btn>
    </v-row>
  ...
  export default {
    ...
    data: () => ({
      links: [
        ...
        img: [
        {
            src: 'https://assets.lms.toolzz.media/70131892/cursos/capas/7ece9dfcb02adb2a2829bb373c67d4ab.png',
          },
          {
            src: 'https://blog-parceiros.ifood.com.br/wp-content/uploads/2022/08/ifood_Banner_ThumbiFoodAnuncios_1500x550px_v2.png',
          },
          {
            src: 'https://assets.propmark.com.br/uploads/2019/12/BK-Imagem-co%CC%81pia.jpg',
          },
          {
            src: 'https://instadelivery-public.nyc3.cdn.digitaloceanspaces.com/groups/168960509564b553e770ba8.jpeg',
          },
        ],
    }),
  }
